...
public class BookGenreServiceImpl extends HibernateServiceImpl<BookGenre,Long> {
    @Autowired
    ...
    @PostConstruct
    public void init() {
        setHibernateDao((HibernateDaoImpl<BookGenre,Long>)((HibernateDaoImpl<?,?>)bookGenreDao));
    }
}
